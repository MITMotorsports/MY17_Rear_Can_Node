...
# C definitions
C_DEFS = -DCORE_M0 -DDEBUG_ENABLE -DCAN_ARCHITECTURE_ARM
...
# c files for testing
C_SRCS_TEST = $(wildcard $(patsubst %, %/*.$(C_EXT), . $(TEST_SRCS_DIRS))) src/state.c src/transfer_functions.c
